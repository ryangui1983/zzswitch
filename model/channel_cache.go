...
func GetRandomSatisfiedChannel(
	...
	return GetRandomSatisfiedChannelExcluding(group, model, retry, "", nil, filters)
}

func GetRandomSatisfiedChannelExcluding(group string, model string, retry int, requestPath string, excluded map[int]bool, filters []dto.ChannelFilter) (*Channel, error) {
	// if memory cache is disabled, get channel directly from database
	if !common.MemoryCacheEnabled {
		return GetChannelExcluding(group, model, retry, requestPath, excluded, filters)
	}
