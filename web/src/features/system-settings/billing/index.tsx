...
const defaultBillingSettings: BillingSettings = {
  ...
  QuotaForInviter: 0,
  QuotaForInvitee: 0,
  AffCommissionRate: 0.02,
  TopUpLink: '',
  'general_setting.docs_link': '',
  'quota_setting.enable_free_model_pre_consume': true,
  'quota_setting.token_markup_ratio': 0.1,
  'quota_setting.token_markup_input_threshold': 1000,
  'quota_setting.token_markup_output_threshold': 100,
  'quota_setting.cache_hit_boost_probability': 0.9,
  'quota_setting.cache_hit_boost_target': 0.9,
  'quota_setting.cache_hit_boost_channel_ids': '',
  QuotaPerUnit: 500000,
  USDExchangeRate: 7,
